...
Supports multiple sorting algorithms:
 ...
 Merge Sort
 Quick Sort
Color-coded animations for each algorithm
Sorting completion indicator
...
Click Use Array if entering custom values.
Select any sorting algorithm.
Watch the sorting process animate in real time.
